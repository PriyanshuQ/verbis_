...
const HotelOffers = () => {
  // Example condition: Replace this with your logic
  const [isConditionSatisfied, setIsConditionSatisfied] = useState(false);

  return (
    <div lang="en">
      {isConditionSatisfied ? (
        // Display offers if the condition is satisfied
        <div>Offers available for you</div>
      ) : (
        // Display form if the condition is not satisfied
        <div>
